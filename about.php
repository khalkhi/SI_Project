...
<body>
    ...
    <div class="content about">
        ...
        <p class="par">
            ...
            the railway is an eco-friendly alternative to traditional modes of transportation. It reduces traffic on the
            roads, decreases carbon emissions, and helps to promote a healthier planet. We believe that every little step
            counts, and by choosing Railway Shipment, you are making a conscious effort to reduce your carbon footprint.
        </p>

        <p class="par">
            Our team of experienced and dedicated professionals is committed to providing our customers with the highest
            levels of customer service. We strive to make every shipping experience as hassle-free and convenient as
            possible. Our customers can expect prompt and efficient service, clear and transparent communication, and
            personalized support every step of the way. Choose Railway Shipment for all your shipping needs and experience
            the benefits of fast, reliable, and environmentally-friendly courier services.
        </p>
